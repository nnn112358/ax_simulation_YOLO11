...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', required=False, default='model/yolo11n_640x640_base.axmodel', help='モデルファイルのパス')
    parser.add_argument('--output', required=False, default='sim_inputs/0', help='中間ファイルの出力先ディレクトリ')
    parser.add_argument('--width', type=int, default=640, help='リサイズ後の幅 (デフォルト: 640)')
    parser.add_argument('--height', type=int, default=640, help='リサイズ後の高さ (デフォルト: 640)')
